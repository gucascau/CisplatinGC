...
#perl ${script}/ExtractSequenceCorrectedBaseOnLength.pl -i 54 -f ${id}_S3_L001_R1_001.fastq -r ${id}_S3_L001_R2_001.fastq -o ${id}_Cfiltered_L001

#perl ${script}/ExtractSequenceCorrectedBaseOnLength.pl  -i 54 -f ${id}_S3_L002_R1_001.fastq -r ${id}_S3_L002_R2_001.fastq -o ${id}_Cfiltered_L002
