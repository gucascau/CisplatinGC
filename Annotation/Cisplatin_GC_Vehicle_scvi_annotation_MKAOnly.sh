#!/bin/bash
#SBATCH --job-name=CispGC_scVI_MKA
#SBATCH --output=/home/gdzepedaorozcolab/lab/xxw004/Projects/RawDZscRNAseq/Results/Integration/IntegrationGC/Annotation/logs/CispGC_scVI_MKA_%j.out
#SBATCH --error=/home/gdzepedaorozcolab/lab/xxw004/Projects/RawDZscRNAseq/Results/Integration/IntegrationGC/Annotation/logs/CispGC_scVI_MKA_%j.err
...
python "${SCRIPT_DIR}/Cisplatin_GC_Vehicle_scvi_annotation_MKAOnly.py"
