...
Pipeline:
  ...
  8. Note: this will use the SubclassLevel2 labels from Lake for annotation, which are more comprehensive than the SubclassLevel1 labels. Adjust if you want to use the broader categories instead.
...
lake_label_col = "SubclassLevel2"     # we will use the comprehensive analysis labels with the subtypes
...
csv_path = os.path.join(out_dir, "Cisplatin_GC_Vehicle_scanvi_LakeL2_annotations.csv")
